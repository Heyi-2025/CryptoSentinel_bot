...
### 7.14 功能菜单改造 (v2.0 已实现)

**之前状态**: `/start` 直接进入订阅流程，没有功能菜单。

**改进方案**:
- `/start` 显示功能菜单，包含 8 个按钮
- 添加"联系开发者"功能
- 所有功能页面都有返回按钮
- "我的状态"显示监控列表
...
### 7.19 管理员充值通知 (v2.0 已实现)

**功能说明**: 用户提交充值申请后自动通知管理员。
